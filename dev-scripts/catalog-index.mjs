...
const USAGE = {
  ...
  previews: "After shortlisting, read each candidate's DESIGN.md, tokens.css, or preview-template.html when present for visual sense.",
  full_read: 'Read DESIGN.md only for the system you ultimately pick as the reference.',
};
