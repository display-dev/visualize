// Vendored from npm package: culori@4.0.2
// Bundled via esbuild for the parse + WCAG contrast subset.
// License: MIT (see https://github.com/Evercoder/culori/blob/main/LICENSE.md).
