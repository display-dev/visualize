...
Top-level guard: if **Grade D or F**, OR ≥3 Absolute bans present, recommend `/visualize simplify <path>` first per SKILL.md refuse-and-route, then re-evaluate. Otherwise, defer to the heuristics-scoring routing table.
