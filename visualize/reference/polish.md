...
- **Artifact has clean bans but many weak dimensions** → recommend a fresh `{{command_prefix}}visualize <topic>` creation pass against the resolved context. Polish is a floor-raise, not a rebuild.
